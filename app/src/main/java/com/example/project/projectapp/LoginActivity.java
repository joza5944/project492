...
//        inputEmail = (EditText) findViewById(R.id.email);
     ...
     * */
    private void checkLogin(final String email_user, final String password) {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (!error) {
                        ...
                        JSONObject user = jObj.getJSONObject("user_user");
                        ...
                        db.addUser(name_user, email_user, uid, created_at ,password ,fist_user ,last_user,
                                sex_user ,created  );
